...
// GreenGrub brand greens - from deep forest to fresh lime
export const brand = {
  50: 'hsl(100, 60%, 96%)',
  100: 'hsl(100, 55%, 90%)',
  200: 'hsl(105, 55%, 78%)',
...
// Warm earthy neutrals instead of cold grays
export const gray = {
  50: 'hsl(220, 35%, 97%)',
  100: 'hsl(220, 30%, 94%)',
  200: 'hsl(220, 20%, 88%)',
...
export const getDesignTokens = (mode) => {
  customShadows[1] =
    mode === 'dark'
      ? 'hsla(120, 20%, 5%, 0.7) 0px 4px 16px 0px, hsla(120, 15%, 10%, 0.8) 0px 8px 16px -5px'
      : 'hsla(120, 20%, 5%, 0.07) 0px 4px 16px 0px, hsla(120, 15%, 10%, 0.07) 0px 8px 16px -5px';
